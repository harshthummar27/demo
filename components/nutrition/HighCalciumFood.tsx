...
interface HighCalciumFoodProps {
  showAsRow?: boolean
}

export default function HighCalciumFood({ showAsRow = false }: HighCalciumFoodProps = {}) {
  const calciumFoods = [
    {
      id: 1,
      name: 'Milk',
    ...
    },
    {
      ...
      description: 'Concentrated source of calcium'
    },
    {
      id: 4,
      name: 'Sardines',
    ...
    },
    {
      ...
      description: 'Leafy green with good calcium content'
    },
    {
      id: 6,
      name: 'Kale',
      ...
      calcium: '180mg',
      calories: '50',
      image: 'https://images.unsplash.com/photo-1604977049386-4bb0b5af3e40?w=400&q=80',
      description: 'Superfood with high calcium'
    },
    {
      id: 7,
      name: 'Broccoli',
      ...
      description: 'Cruciferous vegetable with calcium'
    },
    {
      id: 8,
      name: 'Almonds',
      ...
      description: 'Nuts rich in calcium and healthy fats'
    },
    {
      id: 9,
      name: 'Tofu',
    ...
    },
    {
      ...
      description: 'Vitamin C and calcium fortified'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="text-center mb-6 md:mb-8">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto px-2">
            Discover calcium-rich foods for strong bones and teeth
            {showAsRow && (
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-1.5 mb-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-semibold text-[#9fcc2e]">{food.calcium}</span>
                      </div>
                      <div className="flex justify-between items-center">
        ...
        <div className="text-center mt-8 md:mt-10">
          <Link
            href="/nutrition/high-calcium-foods"
